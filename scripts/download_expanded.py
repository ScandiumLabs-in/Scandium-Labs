...
ELEMENT_SYSTEMS = [
    ...
    ["Li", "S"], ["Li", "P", "S"], ["Li", "Ge", "S"], ["Li", "Sn", "S"],
    ["Li", "La", "Zr", "O"], ["Li", "Y", "Cl"], ["Li", "Y", "Br"],
    ...
    ["Mg", "F"], ["Mg", "Cl"], ["Ca", "F"], ["Ca", "Cl"],
    ["Sr", "F"], ["Sr", "Cl"], ["Ba", "F"], ["Ba", "Cl"],
    # Oxides (rocksalt, perovskite, fluorite)
    ["Mg", "O"], ["Ca", "O"], ["Sr", "O"], ["Ba", "O"],
    ["Mn", "O"], ["Fe", "O"], ["Co", "O"], ["Ni", "O"],
    ["Ti", "O"], ["Zr", "O"], ["Ce", "O"], ["U", "O"],
    # Perovskite formers
    ["Sr", "Ti", "O"], ["Ba", "Ti", "O"], ["La", "Mn", "O"],
    ["Ca", "Ti", "O"], ["Pb", "Ti", "O"],
    # Zincblende / tetrahedral
    ["Si", "Si"], ["Ga", "As"], ["Zn", "S"], ["Cd", "Te"],
    ["In", "P"], ["Ga", "Sb"], ["Al", "As"],
    # Chalcogenides
    ["Li", "O"], ["Na", "O"], ["K", "O"], ["Li", "S"],
    ["Na", "S"], ["K", "S"],
