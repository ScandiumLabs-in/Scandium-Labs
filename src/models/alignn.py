...
class ALIGNNLayer(nn.Module):
    ...
    def forward(self, node_feats, edge_feats, edge_index, lg_node_feats, lg_edge_feats, lg_edge_index):
...
class ALIGNN(nn.Module):
    def __init__(self, atom_feat_dim=92, edge_feat_dim=64, hidden_dim=256,
                 num_layers=4, output_tasks=None):
        super().__init__()
        output_tasks = output_tasks or [
            "ionic_conductivity", "formation_energy",
            "energy_above_hull", "activation_energy"
        ]
